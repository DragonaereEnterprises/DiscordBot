...
export const Purge: Command = {
  ...
  run: async (client: Client, interaction: CommandInteraction, reacord: ReacordDiscordJs) => {
    ...
    if (amount > 100) 
      return reacord.createInteractionReply(interaction, { flags: "Ephemeral" }).render(<EmbedError description="You can only purge 100 messages at a time." />);
    ...
    reacord.createInteractionReply(interaction, { flags: "Ephemeral" }).render(<EmbedMessage title="Purge" description={`Purged ${filtered.size - 1} messages.`} />);
